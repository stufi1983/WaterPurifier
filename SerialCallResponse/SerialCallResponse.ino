...
float firstSensor = 0;    // first analog sensor
...
void loop() {
    ...
    // send sensor values:
    Serial.print("$");
    Serial.print(firstSensor/10);Serial.print(";");
    Serial.print(secondSensor/10);Serial.print(";");
    Serial.print(firstSensor/10);Serial.print(";");
    Serial.print(secondSensor/10+2);Serial.print(";");
    Serial.print(firstSensor/10);Serial.print(";");
    Serial.print(secondSensor/10);
    Serial.println("");
    delay(10);
}
