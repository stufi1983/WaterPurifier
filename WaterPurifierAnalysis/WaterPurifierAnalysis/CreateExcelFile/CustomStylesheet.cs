...
namespace CreateExcelFile
{
    public class CustomStylesheet : Stylesheet
    {
        public CustomStylesheet()
        {
            ...
            numberingFormat5.NumberFormatId = UInt32Value.FromUInt32(iExcelIndex++);
            numberingFormat5.FormatCode = "h:mm;@" ;
            nfs.Append(numberingFormat5);
            
            // index 1
            // Format dd/mm/yyyy
            cf = new CellFormat();
            cf.NumberFormatId = numberingFormat5.NumberFormatId;// 14;
            cf.FontId = 0;
            cf.FillId = 0;
            cf.BorderId = 0;
            cf.FormatId = 0;
